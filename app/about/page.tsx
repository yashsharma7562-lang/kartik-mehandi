...
export default function AboutPage() {
  return (
    <div className="bg-[#FDF5E6] min-h-screen pt-32 pb-24 text-henna">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Layout: Image on left, Philosophy on right */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          
          <div className="relative h-[600px] w-full lg:w-[90%] bg-maroon/5 rounded-none overflow-hidden border border-[#2F4F4F]/10 shadow-xl">
            {/* Minimalist offset border for logic aesthetic */}
            <div className="absolute inset-4 border border-maroon/10 z-20 pointer-events-none" />
            <Image
          ...
          <div className="px-4 lg:px-0">
            <p className="text-sm tracking-[0.32em] uppercase text-maroon mb-4 font-semibold">
              Our Philosophy
            </p>
            <h1 className="text-4xl md:text-5xl font-light uppercase tracking-tight text-henna mb-8 leading-tight">
              The Hand Behind <br /> the Art: <br />
              <span className="italic font-light text-maroon">Kartik&apos;s Passion</span>
            </h1>
            
            <div className="w-16 h-px bg-maroon mb-8" />

            <div className="space-y-6 font-sans font-light text-lg leading-relaxed text-henna/70">
              <p>
                For me, <strong className="text-maroon font-medium">Henna is a ritual, not a job.</strong> It is the delicate thread that connects ancient traditions to the modern bride&apos;s most anticipated day.
              </p>
              <p>
