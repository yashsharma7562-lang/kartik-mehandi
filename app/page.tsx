...
export default function HomePage() {
  return (
    <div className="relative">
      {/* Hero Section */}
      <section className="relative h-screen min-h-[700px] w-full overflow-hidden bg-[#132424]">
        <div className="absolute inset-0 opacity-40">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#132424] via-[#132424]/40 to-transparent" />
        </div>
        ...
        <div className="relative flex h-full items-center justify-center px-6 text-center lg:px-12">
          <motion.div
            ...
            className="max-w-4xl"
          >
            <span className="mb-6 block font-sans text-xs font-semibold uppercase tracking-[0.5em] text-maroon-light">
            ...
            <h1 className="mb-8 font-serif text-5xl font-light leading-[1.1] text-white md:text-7xl lg:text-8xl">
              ...
              <span className="font-script text-maroon-light opacity-90">by Kartik</span>
            </h1>
            <p className="mx-auto mb-12 max-w-2xl font-sans text-lg text-[#FDF5E6]/70 md:text-xl">
            ...
            <div className="flex flex-col items-center justify-center gap-6 sm:flex-row">
              ...
              <Link
                href="/gallery"
                className="group flex items-center gap-3 font-serif text-lg text-white transition-colors hover:text-maroon-light"
              >
        ...
        <div className="absolute bottom-12 left-1/2 -translate-x-1/2">
          <motion.div
            ...
            className="h-12 w-[1px] bg-maroon-light/50"
          />
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-12">
          <div className="grid items-center gap-16 lg:grid-cols-2 lg:gap-24">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <span className="mb-4 block font-sans text-xs font-semibold uppercase tracking-widest text-maroon">
                The Artisan
              </span>
              <h2 className="section-title">A Vision of Elegance</h2>
              <p className="mb-8 text-lg leading-relaxed text-henna/80">
              ...
              <p className="mb-10 text-lg leading-relaxed text-henna/80">
              ...
              <Link
                href="/atelier"
                className="inline-flex items-center gap-3 border-b border-maroon pb-2 font-serif text-xl text-henna transition-colors hover:text-maroon"
              >
      ...
      <section className="bg-white py-24 lg:py-40">
        <div className="mx-auto max-w-7xl px-6 lg:px-12">
          <div className="mb-20 text-center">
            ...
            <p className="mx-auto max-w-2xl text-henna/60">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {highlights.map((item, idx) => (
              ...
              >
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#132424]/80 via-transparent to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
                <div className="absolute bottom-8 left-8 translate-y-4 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">
                  <span className="text-xs uppercase tracking-widest text-maroon-light">{item.category}</span>
       ...
       {/* Services Overview */}
      <section className="bg-henna-light/30 py-24 lg:py-40">
        <div className="mx-auto max-w-7xl px-6 lg:px-12">
            ...
            {services.map((service, idx) => (
              ...
              >
                <div className="mb-8 flex justify-center">
                  <div className="flex h-16 w-16 items-center justify-center rounded-full bg-maroon/10 text-maroon">
                    {service.icon}
                  </div>
                </div>
                <h3 className="mb-4 font-serif text-2xl text-henna">{service.title}</h3>
                <p className="mb-8 text-henna/70 leading-relaxed">
                  {service.desc}
                </p>
                <Link
                  href="/service"
                  className="text-sm font-semibold uppercase tracking-widest text-maroon transition-colors hover:text-maroon-dark"
                >
                  Learn More
                </Link>
              </motion.div>
