...
export function LocationMap() {
  return (
    <section className="w-full bg-[#fffdf9] border-t border-black/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        />
        <div className="mt-12 w-full h-[400px] overflow-hidden rounded-none shadow-xl relative border border-black/5">
          <iframe
